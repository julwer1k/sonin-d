...
const FOLDERS_DATA = [
	{
		...
		media: [
			{ type: 'photo', url: '/memory/trip-1.webp' },
			{ type: 'photo', url: '/memory/trip-2.webp' },
			{ type: 'photo', url: '/memory/trip-3.webp' },
			{ type: 'photo', url: '/memory/trip-4.webp' },
			{ type: 'photo', url: '/memory/trip-5.webp' },
			{ type: 'photo', url: '/memory/trip-6.webp' },
			{ type: 'photo', url: '/memory/trip-7.webp' },
			{ type: 'photo', url: '/memory/trip-8.webp' },
			{ type: 'photo', url: '/memory/trip-9.webp' },
			{ type: 'photo', url: '/memory/trip-10.webp' },
			{ type: 'photo', url: '/memory/trip-11.webp' },
			{ type: 'photo', url: '/memory/trip-12.webp' },
			{ type: 'photo', url: '/memory/trip-13.webp' },
			{ type: 'photo', url: '/memory/trip-14.webp' },
			{ type: 'photo', url: '/memory/trip-15.webp' },
			{ type: 'photo', url: '/memory/trip-16.webp' },
			{ type: 'photo', url: '/memory/trip-17.webp' },
			{ type: 'photo', url: '/memory/trip-18.webp' },
			{ type: 'photo', url: '/memory/trip-19.webp' },
			{ type: 'photo', url: '/memory/trip-20.webp' },
		]
	},
	{
		id: 'childhood',
		...
		media: [
			{ type: 'photo', url: '/memory/kid-1.webp' },
			{ type: 'photo', url: '/memory/kid-2.webp' },
			{ type: 'photo', url: '/memory/kid-3.webp' },
			{ type: 'photo', url: '/memory/kid-4.webp' },
			{ type: 'photo', url: '/memory/kid-5.webp' },
			{ type: 'photo', url: '/memory/kid-6.webp' },
			{ type: 'photo', url: '/memory/kid-7.webp' },
			{ type: 'photo', url: '/memory/kid-8.webp' },
			{ type: 'photo', url: '/memory/kid-9.webp' },
			{ type: 'photo', url: '/memory/kid-10.webp' },
			{ type: 'photo', url: '/memory/kid-11.webp' },
			{ type: 'photo', url: '/memory/kid-12.webp' },
		]
	},
	{
		id: 'family',
		...
		media: [
			{ type: 'photo', url: '/memory/family-1.webp' },
			{ type: 'photo', url: '/memory/family-2.webp' },
			{ type: 'photo', url: '/memory/family-3.webp' },
			{ type: 'photo', url: '/memory/family-4.webp' },
			{ type: 'photo', url: '/memory/family-5.webp' },
			{ type: 'photo', url: '/memory/family-6.webp' },
			{ type: 'photo', url: '/memory/family-7.webp' },
			{ type: 'photo', url: '/memory/family-8.webp' },
		]
	},
];
